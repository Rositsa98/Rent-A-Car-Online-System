...
public class DataInitializer implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        if(carsService.count() == 0) {
            Car car1 = new Car(null, "bmw", 50000.50, 5,4,true,true,true,"https://www.digital.bg/f/logo/704/860_f09e0c434f35ba7adf7626f23a57c58a.jpg","Sofia Airport",null);
            Car car2 = new Car(null, "audi", 30000.50, 5,4,true,true,true,"https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcTeP9tfLp41I_lGmRtmBbKD_Bjr04A9-WyvqDWfgmNs4N6N1_Fw", "Sofia Center",null);
            Car car3 = new Car(null, "peugeot", 20000.50, 5,4,true,true,true,"https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcS4ZCj1h79LIXBadZKq1iQL3hJ3CmFUz_uDTTCXs7MoYqHjAT1-", "Sofia Studentski grad",null);
            Car car4 = new Car(null, "mercedes", 70000.50, 5,4,true,true,true, "https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcTqSV3eQQx_1LEEgDmFhUE8ircoAzQKX0EFJXRNEKpWVYFl4ti8","Sofia Boyana",null);
